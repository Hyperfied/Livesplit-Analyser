  ...
  return (
    <div className="flex flex-col items-center justify-evenly w-full">
      ...
      <div className="h-1/5 w-9/10 bg-[#f3f3f3] border-2 flex flex-row">
        ...
        <TimeWithLabel label="Average Split" timeString={(useGameTime ? currSeg.getAverageSegmentTime().gameTime : currSeg.getAverageSegmentTime().realTime).toString(true, false)} />
      </div>
    </div>
  );
}
