...
function UploadSplitsPage({
  ...
  return (
    <div className="flex h-full w-full justify-center items-center">
      <div
        className={
          "flex flex-col items-center justify-center h-1/3 w-1/2 border-2 border-black rounded-lg p-20 text-center bg-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 gap-10"
        }
      >
        ...
        >
          ...
          <button
            type="submit"
            className="text-lg bg-stone-200 border-0 rounded-full w-fit px-2 py-1 font-semibold cursor-pointer hover:bg-stone-300"
          >
            Analyse
          </button>
        </form>
